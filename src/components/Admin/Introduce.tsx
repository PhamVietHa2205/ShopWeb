            ...
            <div className="row mt-4">
                ...
                <div className="col-lg-5">
                    <div className="card h-100 p-3">
                        <div className="overflow-hidden position-relative border-radius-lg bg-cover h-100" style={{ backgroundImage: `url(${require('../../assets/img/curved-images/ivancik.jpg')})` }} >
