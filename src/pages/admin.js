...
import {ReactComponent as AvatarImg} from '../assets/img/small-logos/logo-xd.svg'
const DashBoard = () => {
	require('../assets/css/soft-ui-dashboard.css');
	require('../assets/scss/soft-ui-dashboard.scss');
											...
											<tbody>
												<tr>
													<td>
														<div className="d-flex px-2 py-1">
															<div>
															<img style={{ width: 40, height: 40 }} src={require('../assets/img/small-logos/logo-xd.svg').default} alt='mySvgImage' />
															</div>
															<div className="d-flex flex-column justify-content-center">
												...
												<tr>
													<td>
														<div className="d-flex px-2 py-1">
															<div>
															<img style={{ width: 40, height: 40 }} src={require('../assets/img/small-logos/logo-atlassian.svg').default} alt='mySvgImage' />
															</div>
															<div className="d-flex flex-column justify-content-center">
												...
												<tr>
													<td>
														<div className="d-flex px-2 py-1">
															<div>
															<img style={{ width: 40, height: 40 }} src={require('../assets/img/small-logos/logo-slack.svg').default} alt='mySvgImage' />
															</div>
															<div className="d-flex flex-column justify-content-center">
												...
												<tr>
													<td>
														<div className="d-flex px-2 py-1">
															<div>
															<img style={{ width: 40, height: 40 }} src={require('../assets/img/small-logos/logo-spotify.svg').default} alt='mySvgImage' />
															</div>
															<div className="d-flex flex-column justify-content-center">
												...
												<tr>
													<td>
														<div className="d-flex px-2 py-1">
															<div>
															<img style={{ width: 40, height: 40 }} src={require('../assets/img/small-logos/logo-jira.svg').default} alt='mySvgImage' />
												...
												<tr>
													<td>
														<div className="d-flex px-2 py-1">
															<div>
															<img style={{ width: 40, height: 40 }} src={require('../assets/img/small-logos/logo-invision.svg').default} alt='mySvgImage' />
															</div>
															<div className="d-flex flex-column justify-content-center">
				...
				<div className="card shadow-lg ">
					...
					<div className="card-body pt-sm-3 pt-0">
						...
						<div className="d-flex">
							<button className="btn bg-gradient-primary w-100 px-3 mb-2 active bg-transparent" onClick="sidebarType(this)">Transparent</button>
							<button className="btn bg-gradient-primary w-100 px-3 mb-2 ms-2 bg-white" onClick="sidebarType(this)">White</button>
						</div>
